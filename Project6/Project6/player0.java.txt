...
public class PITplayer0 implements MessageListener {
    ...
    public void onMessage(Message message) {
        try {
            if (message instanceof ObjectMessage) {
                ...
                if (o instanceof Reset) {
                    ...
                    if (state == null) {
                        ...
                        System.out.println("PITplayer" + myPlayerNumber + " received marker. Card : " + cards.toString());
                        ...
                        if (!isActive) {
                            System.out.println("PITplayer " + myPlayerNumber + " state before adding commodities from channels " + state);
            ...
            System.out.println("PITplayer" + myPlayerNumber + " cards size " + cards.size() + " cards before sending " + cards);
            newTrade.tradeCard = (String) cards.remove(0);
            System.out.println("PITplayer" + myPlayerNumber + " cards size " + cards.size() + " cards after sending " + cards);
