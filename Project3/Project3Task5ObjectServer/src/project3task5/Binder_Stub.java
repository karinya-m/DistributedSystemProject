...
/**
 * This class represents stub for binder, communication with registry.
 * @author Karinya
 */
public class Binder_Stub implements Binder {
    ...
    /**
     * This method look up for remote reference stored in the registry from the given name.
     * @param name
     * @return Object of RemoteObjectRefernce that matches the given name
     */
    public RemoteObjectReference lookup(String name) {
        ...
        try {
            ...
            // while the second of argument is a name that is needed to be looked up.
    ...
    /**
     * This class stores pair of given string and remoteObjectReference in registry
     * @param name
     * @param obj
     */
    public void bind(String name, RemoteObjectReference obj) {
        ...
        try {
            ...
            // The arguments are method name, name to be looked up, and remote object reference respectively.
