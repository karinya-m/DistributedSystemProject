...
public class UpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       Double scholarship = Double.parseDouble(request.getParameter("scholarship"));
        ...
        if (P2T5WebAppWebServiceClientProjectModel.updateStudent(studentID, stduentName, scholarship)) {
            request.setAttribute("result", "Student record is updated.");
        } else {
            request.setAttribute("result", "Fail to update student record");
        }
